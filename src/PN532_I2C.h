...
public:
    ...
    void wakeup();
    int8_t writeCommand(const uint8_t *header,const uint8_t hlen,const uint8_t *body,const uint16_t blen);
    int8_t writeCommand(const uint8_t *header,const uint8_t hlen,const uint8_t **bodylist,const uint16_t *blenlist,const uint8_t bodycount);
